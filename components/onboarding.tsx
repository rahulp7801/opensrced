...
const STEPS = [
  {
    ...
    description: "Required to power the AI agent. Your key is encrypted and never stored on disk.",
    href: "/crucible",
    cta: "Go to API Keys",
  ...
  },
  {
    key: "org" as const,
    number: "2",
    title: "Connect a GitHub org",
    description: "Install the GitHub App on an organization to scan private repos for bugs and vulnerabilities.",
    href: "/crucible",
    cta: "Connect org",
  ...
  },
  {
    ...
    number: "3",
    title: "Solve your first issue",
    description: "Navigate to a repo, pick an issue, and click deep solve. Watch the agent explore, patch, test, and open a PR.",
    href: "/discover",
    cta: "Find an issue",
