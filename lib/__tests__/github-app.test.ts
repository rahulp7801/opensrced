...
import { getInstallationToken, installationFetch, mintInstallationToken } from "../crucible/github-app";
import { gitAuthArgs, redactGitCredentials } from "../git-auth";

const privateKey = generateKeyPairSync("rsa", { modulusLength: 2048 }).privateKey.export({ type: "pkcs8", format: "pem" }).toString();

test("concurrent installation requests share one mint and refresh after expiry", async (t) => {
